...
public class AirThermometer implements FishTankDevice {
	...
	private static final Logger LOGGER = Logger.getLogger(AirThermometer.class.getName());
	...
	public boolean writeToFile() {
		if (!this.isRunning) {
			...
			writer.setDataFilePath("src/main/resources/air-thermometer-" + this.id + "-data.json");
